<?php
/**
 * REXTIAN SSO - POST /api/apps/reset-secret.php
 * 重置 Client Secret
 */
...
$pdo->prepare("UPDATE oauth_apps SET client_secret = ? WHERE id = ?")->execute([$newSecret, $id]);

$adminId = $_SESSION['user_id'] ?? 0;
auditLog('app.reset_secret', $adminId, null, ['app_id' => $id, 'name' => $app['name']], 'success');
